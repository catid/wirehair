...
#ifndef WIREHAIR_WH2_NATIVE_RDPRU_AA_V2_SOURCE_SHA256
#define WIREHAIR_WH2_NATIVE_RDPRU_AA_V2_SOURCE_SHA256 "unknown"
#endif

#ifndef WIREHAIR_WH2_NATIVE_RDPRU_AA_V1_PARENT_SOURCE_SHA256
#define WIREHAIR_WH2_NATIVE_RDPRU_AA_V1_PARENT_SOURCE_SHA256 "unknown"
#endif

#ifndef WIREHAIR_WH2_RDPRU_TARGET_IDENTITY_V2_SOURCE_SHA256
#define WIREHAIR_WH2_RDPRU_TARGET_IDENTITY_V2_SOURCE_SHA256 "unknown"
#endif

#ifndef WIREHAIR_WH2_RDPRU_TARGET_IDENTITY_V2_HEADER_SHA256
#define WIREHAIR_WH2_RDPRU_TARGET_IDENTITY_V2_HEADER_SHA256 "unknown"
#endif
...
extern "C" const unsigned char wh2_rdpru_target_v2_bracket_opcode_begin[];
extern "C" const unsigned char wh2_rdpru_target_v2_bracket_opcode_end[];
#endif
...
using wirehair_wh2_bench::CpuInfoMapRecordV2;
using wirehair_wh2_bench::TargetIdentityReceiptV2;

static const char kProtocolTag[] =
    "wirehair1-native-rdpru-batch128-aa-target-v2";
static const char kTargetIdentitySchema[] =
    "wirehair-rdpru-target-identity-receipt-v2";
static const char kTargetIdentityDomain[] =
    "wirehair-rdpru-target-identity-v2";
static const char kCpuInfoMapSchema[] =
    "wirehair-linux-cpu-apic-map-v2";
static const uint64_t kExpectedTargetIdentityCanonicalBytes = UINT64_C(617);
static const char kExpectedTargetIdentitySha256[] =
    "3288e0ef61cf3e628dcd827f9cf003c9d6ec6b5a12169e7a8bfc796baacddba7";
static const uint64_t kExpectedCpuInfoMapCanonicalBytes = UINT64_C(6818);
static const char kExpectedCpuInfoMapSha256[] =
    "d51bf8bf7c1b249d081d8447fd35f118f2d5bfeee49d2a8f3bc2aba507744d8b";
static const char kExpectedParentSourceSha256[] =
    "0f553cce1df3acbc016250ccdf10fe3288980b3ae22bd4c6ee5c98e19bffa852";
static const char kExpectedTargetIdentitySourceSha256[] =
    "51ce3b59fcacd378e69da5c8e4a25327369a50fbae6809bccfeedcd4b72dc7b2";
static const char kExpectedTargetIdentityHeaderSha256[] =
    "af484c4382a5ec5ffab52fc3dfd5398b6d8dfed30d2347930c2f65c1787aa42c";
#if defined(__linux__)
static const char kLaunchManifestSchema[] =
    "wirehair-rdpru-target-launch-manifest-v2";
#endif
...
static const uint32_t kFrozenLeaf1Ebx = UINT32_C(0x64800800);
...
static const char kExpectedConfigSha256[] =
    "0bffb435b6086957f8d079c910f81c671274c741fae88480db5788d5f959503e";
...
bool EmbeddedIdentitiesValid()
{
    return std::strcmp(WIREHAIR_WH2_SOURCE_GIT_COMMIT, "unknown") != 0 &&
        ...
        IsLowerHexSha256(WIREHAIR_WH2_NATIVE_RDPRU_AA_V2_SOURCE_SHA256) &&
        !IsAllZeroHex(WIREHAIR_WH2_NATIVE_RDPRU_AA_V2_SOURCE_SHA256) &&
        IsLowerHexSha256(
            WIREHAIR_WH2_NATIVE_RDPRU_AA_V1_PARENT_SOURCE_SHA256) &&
        std::strcmp(
            WIREHAIR_WH2_NATIVE_RDPRU_AA_V1_PARENT_SOURCE_SHA256,
            kExpectedParentSourceSha256) == 0 &&
        IsLowerHexSha256(
            WIREHAIR_WH2_RDPRU_TARGET_IDENTITY_V2_SOURCE_SHA256) &&
        std::strcmp(
            WIREHAIR_WH2_RDPRU_TARGET_IDENTITY_V2_SOURCE_SHA256,
            kExpectedTargetIdentitySourceSha256) == 0 &&
        IsLowerHexSha256(
            WIREHAIR_WH2_RDPRU_TARGET_IDENTITY_V2_HEADER_SHA256) &&
        std::strcmp(
            WIREHAIR_WH2_RDPRU_TARGET_IDENTITY_V2_HEADER_SHA256,
            kExpectedTargetIdentityHeaderSha256) == 0 &&
...
std::string ConfigSha256(const std::string& schedule_sha256)
{
    ...
    AppendSizedString(bytes, kTargetIdentitySchema);
    AppendSizedString(bytes, kTargetIdentityDomain);
    AppendLe64(bytes, kExpectedTargetIdentityCanonicalBytes);
    AppendSizedString(bytes, kExpectedTargetIdentitySha256);
    AppendSizedString(bytes, kCpuInfoMapSchema);
    AppendLe64(bytes, kExpectedCpuInfoMapCanonicalBytes);
    AppendSizedString(bytes, kExpectedCpuInfoMapSha256);
    AppendSizedString(
        bytes, WIREHAIR_WH2_NATIVE_RDPRU_AA_V1_PARENT_SOURCE_SHA256);
    AppendSizedString(
        bytes, WIREHAIR_WH2_RDPRU_TARGET_IDENTITY_V2_SOURCE_SHA256);
    AppendSizedString(
        bytes, WIREHAIR_WH2_RDPRU_TARGET_IDENTITY_V2_HEADER_SHA256);
...
bool ReadRdpru(void* context, uint32_t selector, uint64_t* value_out)
{
    ...
    __asm__ __volatile__(
        ".globl wh2_rdpru_target_v2_bracket_opcode_begin\n\t"
        "wh2_rdpru_target_v2_bracket_opcode_begin:\n\t"
        "mfence\n\t"
        "lfence\n\t"
        ".byte 0x0f, 0x01, 0xfd\n\t"
        "shlq $32, %%rdx\n\t"
        "orq %%rdx, %%rax\n\t"
        "lfence\n\t"
        ".globl wh2_rdpru_target_v2_bracket_opcode_end\n\t"
        "wh2_rdpru_target_v2_bracket_opcode_end:\n\t"
        : "=&a"(value)
        : "c"(selector)
        : "rdx", "cc", "memory");
    __asm__ __volatile__("" ::: "memory");
    ...
    const std::string& diagnostic)
{
    ...
    payload << "CALIBRATION_DIAGNOSTIC_LENGTH=" << diagnostic.size() << '\n'
            ...
            << "WIREHAIR1_NATIVE_RDPRU_BATCH128_AA_TARGET_V2_CALIBRATION="
    ...
    std::string& diagnostic)
{
    ...
    const struct ExpectedField
    {
        ...
        { "controller_sha256", WIREHAIR_WH2_NATIVE_RDPRU_AA_V2_SOURCE_SHA256 },
        { "parent_controller_source_sha256",
          WIREHAIR_WH2_NATIVE_RDPRU_AA_V1_PARENT_SOURCE_SHA256 },
        { "target_identity_source_sha256",
          WIREHAIR_WH2_RDPRU_TARGET_IDENTITY_V2_SOURCE_SHA256 },
        { "target_identity_header_sha256",
          WIREHAIR_WH2_RDPRU_TARGET_IDENTITY_V2_HEADER_SHA256 },
        { "target_identity_schema", kTargetIdentitySchema },
        { "target_identity_domain", kTargetIdentityDomain },
        { "target_identity_canonical_bytes", "617" },
        { "target_identity_sha256", kExpectedTargetIdentitySha256 },
        { "cpu_apic_map_schema", kCpuInfoMapSchema },
        { "cpu_apic_map_canonical_bytes", "6818" },
        { "cpu_apic_map_sha256", kExpectedCpuInfoMapSha256 },
    ...
    const std::string& launch_manifest_sha256)
{
    evidence << "PROTOCOL,tag=" << kProtocolTag << '\n'
             ...
             << "TARGET_IDENTITY_EXPECTED,schema=" << kTargetIdentitySchema
             << ",domain=" << kTargetIdentityDomain
             << ",canonical_bytes="
             << kExpectedTargetIdentityCanonicalBytes
             << ",sha256=" << kExpectedTargetIdentitySha256
             << ",cpu_apic_map_schema=" << kCpuInfoMapSchema
             << ",cpu_apic_map_canonical_bytes="
             << kExpectedCpuInfoMapCanonicalBytes
             << ",cpu_apic_map_sha256=" << kExpectedCpuInfoMapSha256
             << '\n'
...
typedef bool (*TargetIdentityCheckpointCaptureFunctionV2)(
    void* context,
    const std::string& checkpoint,
    TargetIdentityReceiptV2& receipt,
    std::string& diagnostic);

bool NativeTargetIdentityCheckpointCaptureV2(
    void*,
    const std::string&,
    TargetIdentityReceiptV2& receipt,
    std::string& diagnostic)
{
    return wirehair_wh2_bench::CaptureNativeTargetIdentityV2(
        receipt, diagnostic);
}

bool CaptureExactTargetIdentityCheckpointV2(
    const std::string& checkpoint,
    std::ostringstream& evidence,
    std::string& diagnostic,
    TargetIdentityCheckpointCaptureFunctionV2 capture,
    void* capture_context)
{
    TargetIdentityReceiptV2 receipt;
    std::string capture_diagnostic;
    bool captured = false;
    try {
        captured = capture && capture(
            capture_context, checkpoint, receipt, capture_diagnostic);
    }
    catch (const std::exception& error) {
        capture_diagnostic =
            std::string("target identity capture threw: ") + error.what();
    }
    catch (...) {
        capture_diagnostic =
            "target identity capture threw a non-standard exception";
    }
    std::string exact_diagnostic;
    bool exact = captured &&
        wirehair_wh2_bench::ValidateFrozenCpu50IdentityV2(
            receipt, exact_diagnostic);
    if (exact &&
        (wirehair_wh2_bench::FrozenCpu50TargetIdentityCanonicalBytesV2() !=
                kExpectedTargetIdentityCanonicalBytes ||
         wirehair_wh2_bench::FrozenCpu50TargetIdentitySha256V2() !=
                kExpectedTargetIdentitySha256))
    {
        exact = false;
        exact_diagnostic =
            "controller and identity module golden receipt disagree";
    }
    diagnostic = captured ? exact_diagnostic : capture_diagnostic;
    if (!exact && diagnostic.empty()) {
        diagnostic = "target identity checkpoint failed without diagnostic";
    }
    evidence << wirehair_wh2_bench::FormatTargetIdentityEvidenceV2(
        checkpoint, receipt, exact, diagnostic);
    evidence << "TARGET_IDENTITY_BINDING_V2,checkpoint_length="
             << checkpoint.size()
             << ",checkpoint_hex=" << HexEncode(checkpoint)
             << ",schema_length=" << (sizeof(kTargetIdentitySchema) - 1u)
             << ",schema_hex=" << HexEncode(kTargetIdentitySchema)
             << ",domain_length=" << (sizeof(kTargetIdentityDomain) - 1u)
             << ",domain_hex=" << HexEncode(kTargetIdentityDomain)
             << ",expected_canonical_bytes="
             << kExpectedTargetIdentityCanonicalBytes
             << ",expected_sha256=" << kExpectedTargetIdentitySha256
             << ",capture_gate=" << (captured ? "PASS" : "FAIL")
             << ",exact_gate=" << (exact ? "PASS" : "FAIL") << '\n';
    if (exact) diagnostic.clear();
    return exact;
}
...
bool CaptureExactTargetIdentityCheckpointV2(
    ...
    std::string& diagnostic)
{
    return CaptureExactTargetIdentityCheckpointV2(
        checkpoint,
        evidence,
        diagnostic,
        NativeTargetIdentityCheckpointCaptureV2,
        nullptr);
}

bool CaptureCpuInfoMapCheckpointV2(
    const std::string& checkpoint,
    std::ostringstream& evidence,
    std::string& diagnostic)
{
    ...
    const bool read = wirehair_wh2_bench::ReadProcCpuInfoV2(
        "/proc/cpuinfo", records, read_diagnostic);
    std::string exact_diagnostic;
    const bool exact = read &&
        wirehair_wh2_bench::ValidateFrozenCpuInfoMapV2(
            records, exact_diagnostic);
    std::string canonical;
    std::string canonical_diagnostic;
    const bool canonicalized = read &&
        wirehair_wh2_bench::CanonicalizeCpuInfoMapV2(
            records, canonical, canonical_diagnostic);
    std::string hash_diagnostic;
    const std::string observed_sha256 = read ?
        wirehair_wh2_bench::CpuInfoMapSha256V2(
            records, hash_diagnostic) : std::string();
    const bool binding =
        wirehair_wh2_bench::FrozenCpuInfoMapCanonicalBytesV2() ==
            kExpectedCpuInfoMapCanonicalBytes &&
        std::strcmp(
            wirehair_wh2_bench::FrozenCpuInfoMapSha256V2(),
            kExpectedCpuInfoMapSha256) == 0;
    const bool pass = read && exact && canonicalized && binding &&
        canonical.size() == kExpectedCpuInfoMapCanonicalBytes &&
        observed_sha256 == kExpectedCpuInfoMapSha256;
    if (!read) diagnostic = read_diagnostic;
    else if (!exact) diagnostic = exact_diagnostic;
    else if (!canonicalized) diagnostic = canonical_diagnostic;
    else if (!binding) {
        diagnostic = "controller and identity module CPU/APIC map disagree";
    }
    else if (observed_sha256 != kExpectedCpuInfoMapSha256 ||
             canonical.size() != kExpectedCpuInfoMapCanonicalBytes) {
        diagnostic = "CPU/APIC map canonical receipt mismatch";
    }
    if (!pass && diagnostic.empty()) {
        diagnostic = hash_diagnostic.empty() ?
            "CPU/APIC map checkpoint failed without diagnostic" :
            hash_diagnostic;
    }
    evidence << "CPU_APIC_MAP_V2,checkpoint_length=" << checkpoint.size()
             << ",checkpoint_hex=" << HexEncode(checkpoint)
             << ",schema_length=" << (sizeof(kCpuInfoMapSchema) - 1u)
             << ",schema_hex=" << HexEncode(kCpuInfoMapSchema)
             << ",record_count=" << records.size()
             << ",expected_canonical_bytes="
             << kExpectedCpuInfoMapCanonicalBytes
             << ",observed_canonical_bytes=" << canonical.size()
             << ",expected_sha256=" << kExpectedCpuInfoMapSha256
             << ",observed_sha256=" << observed_sha256
             << ",canonical_hex=" << HexEncode(canonical)
             << ",diagnostic_length=" << diagnostic.size()
             << ",diagnostic_hex=" << HexEncode(diagnostic)
             << ",read_gate=" << (read ? "PASS" : "FAIL")
             << ",exact_gate=" << (exact ? "PASS" : "FAIL")
             << ",gate=" << (pass ? "PASS" : "FAIL") << '\n';
    if (pass) diagnostic.clear();
    return pass;
}

template <typename Operation>
bool RunIdentityBracketedStageV2(
    ...
    Operation operation)
{
    std::string pre_diagnostic;
    const bool pre = CaptureExactTargetIdentityCheckpointV2(
        stage + "-pre",
        evidence,
        pre_diagnostic,
        capture,
    ...
    if (pre)
    {
        ...
        try {
            ...
            if (!operation_passed) primary_diagnostic = diagnostic;
        }
        catch (const std::exception& error) {
            primary_diagnostic =
                std::string("identity-bracketed stage threw: ") + error.what();
        }
        catch (...) {
            primary_diagnostic =
                "identity-bracketed stage threw a non-standard exception";
        }
        if (!operation_passed && primary_diagnostic.empty()) {
            primary_diagnostic =
                "identity-bracketed stage failed without diagnostic";
        }
    }
    else {
        primary_diagnostic = pre_diagnostic;
    }
    std::string post_diagnostic;
    const bool post = CaptureExactTargetIdentityCheckpointV2(
        stage + "-post",
        evidence,
        post_diagnostic,
        capture,
        capture_context);
    evidence << "TARGET_IDENTITY_STAGE_V2,stage_length=" << stage.size()
             << ",stage_hex=" << HexEncode(stage)
             << ",pre_gate=" << (pre ? "PASS" : "FAIL")
             << ",operation_attempted=" << (operation_attempted ? 1u : 0u)
             << ",operation_gate="
             << (operation_passed ? "PASS" : "FAIL")
             << ",post_gate=" << (post ? "PASS" : "FAIL")
             << ",primary_diagnostic_length=" << primary_diagnostic.size()
             << ",primary_diagnostic_hex=" << HexEncode(primary_diagnostic)
             << ",post_diagnostic_length=" << post_diagnostic.size()
             << ",post_diagnostic_hex=" << HexEncode(post_diagnostic) << '\n';
    if (!pre || !operation_passed) {
        diagnostic = primary_diagnostic;
        return false;
    }
    if (!post) {
        diagnostic = post_diagnostic;
        return false;
    }
    diagnostic.clear();
    return true;
...
bool RunIdentityBracketedStageV2(
    ...
    Operation operation)
{
    return RunIdentityBracketedStageV2(
        stage,
        evidence,
        diagnostic,
        NativeTargetIdentityCheckpointCaptureV2,
    ...
    const std::string& diagnostic)
{
    ...
    const bool publication_map = CaptureCpuInfoMapCheckpointV2(
        "pre-publication", evidence, map_diagnostic);
    const bool final_valid = valid && publication_map;
    std::string final_diagnostic = diagnostic;
    if (!publication_map)
    {
        evidence << "PRE_PUBLICATION_MAP_FAILURE,primary_preserved="
                 << (valid ? 0u : 1u)
                 << ",diagnostic_length=" << map_diagnostic.size()
                 << ",diagnostic_hex=" << HexEncode(map_diagnostic) << '\n';
        if (valid) final_diagnostic = map_diagnostic;
    }
    ...
    const std::string payload = FinalizeCalibrationPayload(
        evidence.str(), final_valid, final_diagnostic);
    std::string publication_diagnostic;
    if (!AtomicPublishNew(output_path, payload, publication_diagnostic))
    {
        std::cerr << "Wirehair1 native RDPRU batch128 A/A target-v2 evidence publication "
            ...
            final_valid))
    {
        std::cerr << "EVIDENCE_PUBLICATION_AUTHORITY=FAIL\n"
                  << "WIREHAIR1_NATIVE_RDPRU_BATCH128_AA_TARGET_V2_CALIBRATION=INVALID\n";
        std::cerr.flush();
        return 1;
    }
    return final_valid ? 0 : 1;
}
    ...
    std::ostringstream& evidence)
{
    ...
    if (!CaptureCpuInfoMapCheckpointV2("pre-pin", evidence, diagnostic)) {
        return PublishCalibration(output_path, evidence, false, diagnostic);
    }
    if (!PinCpuOnce(target_cpu, diagnostic)) {
        return PublishCalibration(output_path, evidence, false, diagnostic);
    }
    if (!CaptureExactTargetIdentityCheckpointV2(
            "post-pin-initial", evidence, diagnostic)) {
        return PublishCalibration(output_path, evidence, false, diagnostic);
    }
    CpuFeatures features;
    if (!RunIdentityBracketedStageV2(
            "access",
            evidence,
            diagnostic,
            [&]() -> bool {
                ...
                if (!ValidateLaunchManifestHost(
                        launch_manifest, features, diagnostic))
                {
                ...
                for (uint32_t selector = 0u; selector < 2u; ++selector)
                {
                    ...
                    {
                        std::ostringstream message;
                        message << "guarded RDPRU access failed selector="
                                << selector
                                << ",first_ok="
                                << (access.FirstOk ? 1u : 0u)
                                << ",second_ok="
                                << (access.SecondOk ? 1u : 0u)
    ...
    if (!RunIdentityBracketedStageV2(
            ...
            [&]() -> bool {
                if (!BuildFrozenSchedule(schedule)) {
                    diagnostic = "schedule construction failed";
                    return false;
                }
                ...
                evidence << "FREEZE_EXPECTED,schedule_sha256="
                         ...
                         << kExpectedTargetIdentitySha256
                         << ",cpu_apic_map_sha256="
                         << kExpectedCpuInfoMapSha256 << '\n'
                         << "FREEZE_OBSERVED,schedule_sha256="
                         << schedule_sha256
                    ...
                    config_sha256 != kExpectedConfigSha256)
                {
                    ...
                    diagnostic = "frozen schedule/config hash mismatch";
                    return false;
                }
    ...
    if (!RunIdentityBracketedStageV2(
            ...
            diagnostic,
            [&]() -> bool {
                if (!CaptureCpuInfoMapCheckpointV2(
                        "pre-fixture", evidence, diagnostic)) {
                    return false;
                }
                if (wirehair_init() != Wirehair_Success) {
                    diagnostic = "wirehair_init failed";
                    return false;
                }
                ...
                evidence << "FIXTURE,expected_sha256="
                         << kExpectedFixtureSha256
                         << ",observed_sha256=" << fixture_sha256
                         << ",preflight_batches=" << kPreflightBatchCount
                         << ",preflight_inner="
                         << kPreflightInnerInvocationCount
                         << ",gate="
                         << (fixture_sha256 == kExpectedFixtureSha256 ?
                                "PASS" : "FAIL")
                         << '\n';
                if (fixture_sha256 != kExpectedFixtureSha256) {
                    diagnostic = "frozen fixture hash mismatch";
                    return false;
                }
                return true;
            }))
    ...
    if (!RunIdentityBracketedStageV2(
            ...
            [&]() -> bool {
                ...
                if (ValidateEmptyReceipts(
                        run_state.Empty, target_cpu, diagnostic)) {
                    return true;
                }
                RecordStageFailure(
                    run_state.Failure,
    ...
    uint32_t injected_exception)
{
    ...
    catch (const std::exception& exception)
    {
        ...
        std::cerr << "native RDPRU batch128 A/A target-v2 exception publication failed\n";
    }
    catch (...)
    {
        try
...
struct InjectedIdentityCheckpointStateV2
{
    std::vector<std::string> Events;
    size_t CaptureCount = 0u;
    size_t FailAt = std::numeric_limits<size_t>::max();
    size_t ThrowAt = std::numeric_limits<size_t>::max();
    size_t MutateAt = std::numeric_limits<size_t>::max();
};

bool InjectedIdentityCheckpointCaptureV2(
    void* context,
    const std::string& checkpoint,
    TargetIdentityReceiptV2& receipt,
    std::string& diagnostic)
{
    InjectedIdentityCheckpointStateV2* const state =
        static_cast<InjectedIdentityCheckpointStateV2*>(context);
    if (!state) {
        diagnostic = "injected identity checkpoint context is null";
        return false;
    }
    const size_t ordinal = state->CaptureCount++;
    state->Events.push_back(std::string("capture:") + checkpoint);
    if (ordinal == state->ThrowAt) {
        throw std::runtime_error("injected identity capture exception");
    }
    if (ordinal == state->FailAt) {
        diagnostic = std::string("injected identity capture failure: ") +
            checkpoint;
        return false;
    }
    receipt = wirehair_wh2_bench::FrozenCpu50TargetIdentityReceiptV2();
    if (ordinal == state->MutateAt) {
        receipt.Derived.FullApicId ^= 1u;
    }
    diagnostic.clear();
    return true;
}

bool TestTargetIdentityModuleIntegration()
{
    if (!EmbeddedIdentitiesValid() ||
        std::strcmp(
            WIREHAIR_WH2_NATIVE_RDPRU_AA_V1_PARENT_SOURCE_SHA256,
    ...
    std::string diagnostic;
    if (!wirehair_wh2_bench::RunTargetIdentityV2SelfTests(diagnostic)) {
        return false;
    }
    const TargetIdentityReceiptV2 frozen =
        wirehair_wh2_bench::FrozenCpu50TargetIdentityReceiptV2();
    std::string canonical;
    if (!wirehair_wh2_bench::SerializeTargetIdentityV2(
            frozen, canonical, diagnostic) ||
        canonical.size() != kExpectedTargetIdentityCanonicalBytes ||
        wirehair_wh2_bench::TargetIdentitySha256V2(frozen, diagnostic) !=
            kExpectedTargetIdentitySha256 ||
        wirehair_wh2_bench::FrozenCpu50TargetIdentityCanonicalBytesV2() !=
            kExpectedTargetIdentityCanonicalBytes ||
        wirehair_wh2_bench::FrozenCpu50TargetIdentitySha256V2() !=
    ...
    AppendInitialEvidence(
        evidence,
        kFrozenTargetCpu,
        "/tmp/wirehair-rdpru-evidence-v2",
        "/tmp/wirehair-rdpru-launch-manifest-v2",
        std::string(64u, '1'));
    const std::string text = evidence.str();
    return text.find(
            std::string("TARGET_IDENTITY_EXPECTED,schema=") +
                kTargetIdentitySchema + ",domain=" + kTargetIdentityDomain +
                ",canonical_bytes=617,sha256=" +
                kExpectedTargetIdentitySha256) != std::string::npos &&
        text.find(
            std::string(",cpu_apic_map_schema=") + kCpuInfoMapSchema +
                ",cpu_apic_map_canonical_bytes=6818,cpu_apic_map_sha256=" +
                kExpectedCpuInfoMapSha256) != std::string::npos &&
        text.find(
            std::string(",parent_controller_source_sha256=") +
                kExpectedParentSourceSha256) != std::string::npos &&
        text.find(
            std::string(",target_identity_source_sha256=") +
                kExpectedTargetIdentitySourceSha256) != std::string::npos &&
        text.find(
            std::string(",target_identity_header_sha256=") +
                kExpectedTargetIdentityHeaderSha256) != std::string::npos;
}

bool TestIdentityCheckpointSequencing()
{
    const std::vector<std::string> expected = {
        "capture:injected-pre", "operation", "capture:injected-post"
    };
    std::string diagnostic;
    {
        InjectedIdentityCheckpointStateV2 state;
        std::ostringstream evidence;
        const bool passed = RunIdentityBracketedStageV2(
            "injected",
            evidence,
            diagnostic,
            InjectedIdentityCheckpointCaptureV2,
            &state,
            [&]() -> bool {
                state.Events.push_back("operation");
                return true;
            });
        const std::string text = evidence.str();
        if (!passed || !diagnostic.empty() || state.Events != expected ||
            text.find("TARGET_IDENTITY_STAGE_V2,") == std::string::npos ||
            text.find("operation_attempted=1,operation_gate=PASS,post_gate=PASS") ==
                std::string::npos)
        {
            return false;
        }
    }
    {
        ...
        const bool passed = RunIdentityBracketedStageV2(
            ...
            [&]() -> bool {
                state.Events.push_back("operation");
                diagnostic = "primary injected stage failure";
                return false;
            });
        if (passed || diagnostic != "primary injected stage failure" ||
            state.Events != expected ||
            evidence.str().find("post_gate=PASS") == std::string::npos)
        {
            return false;
        }
    }
    {
        ...
        if (passed || diagnostic != "primary injected stage failure" ||
            state.Events != expected ||
            evidence.str().find("post_gate=FAIL") == std::string::npos)
        {
            return false;
        }
    }
    {
        ...
        const std::vector<std::string> expected_pre_failure = {
            "capture:injected-pre", "capture:injected-post"
        };
        if (passed || state.Events != expected_pre_failure ||
            diagnostic != "injected identity capture failure: injected-pre" ||
            evidence.str().find("operation_attempted=0") == std::string::npos)
        {
            return false;
        }
    }
    {
        ...
        if (passed || state.Events != expected ||
            diagnostic != "injected identity capture failure: injected-post")
        {
            return false;
        }
    }
    {
        ...
        if (passed || state.Events != expected ||
            diagnostic.find("target identity capture threw") ==
                std::string::npos ||
            evidence.str().find("post_gate=FAIL") == std::string::npos)
        {
            return false;
    ...
    }
    {
        ...
        if (passed || state.Events != expected || diagnostic.empty() ||
            evidence.str().find("post_gate=FAIL") == std::string::npos ||
            evidence.str().find("exact_gate=FAIL") == std::string::npos)
        {
            return false;
        }
    }
    {
        ...
        const std::vector<std::string> expected_exact_failure = {
            "capture:injected-pre", "capture:injected-post"
        };
        if (passed || state.Events != expected_exact_failure ||
            diagnostic.empty() ||
            evidence.str().find("exact_gate=FAIL") == std::string::npos)
        {
            return false;
    ...
    }
    {
        ...
        if (passed || state.Events != expected ||
            diagnostic.find("injected stage exception") == std::string::npos ||
            evidence.str().find("post_gate=PASS") == std::string::npos)
        {
            return false;
        }
    }
    {
        ...
        if (passed || state.Events != expected ||
            diagnostic.find("non-standard") == std::string::npos ||
            evidence.str().find("post_gate=PASS") == std::string::npos)
        {
            return false;
        }
    }
    {
        ...
        const std::vector<std::string> expected_capture_throw = {
            "capture:injected-pre", "capture:injected-post"
        };
        if (passed || state.Events != expected_capture_throw ||
            diagnostic.find("target identity capture threw") ==
                std::string::npos ||
            evidence.str().find("post_gate=PASS") == std::string::npos)
        {
...
bool TestReaderOpcodeShape()
{
    ...
    if (code_size != sizeof(expected) ||
        std::memcmp(code, expected, sizeof(expected)) != 0) return false;
...
{
#if defined(__linux__) && defined(SYS_renameat2)
    char directory_template[] = "/tmp/wh2-rdpru-target-v2-selftest-XXXXXX";
...
#if defined(__linux__)
class GroupEveryDigitNumpunctV2 : public std::numpunct<char>
{
protected:
...
class GlobalLocaleRestoreV2
{
public:
    GlobalLocaleRestoreV2() : Saved(std::locale()) {}
    ~GlobalLocaleRestoreV2()
    {
        try {
    ...
    const std::string& output_path)
{
    ...
    content << "manifest_schema=" << kLaunchManifestSchema << '\n'
            ...
            << "target_identity_schema=" << kTargetIdentitySchema << '\n'
            << "target_identity_domain=" << kTargetIdentityDomain << '\n'
            << "target_identity_canonical_bytes="
            << kExpectedTargetIdentityCanonicalBytes << '\n'
            << "target_identity_sha256="
            << kExpectedTargetIdentitySha256 << '\n'
            << "cpu_apic_map_schema=" << kCpuInfoMapSchema << '\n'
...
bool TestLaunchManifestGate()
{
    ...
    char directory_template[] = "/tmp/wh2-rdpru-target-v2-manifest-XXXXXX";
    char* const directory = mkdtemp(directory_template);
    if (!directory) return false;
    ...
    std::string localized_content;
    {
        GlobalLocaleRestoreV2 restore;
        const std::locale grouped(
            std::locale::classic(), new GroupEveryDigitNumpunctV2());
    ...
    bool ok = !content.empty() && localized_content == content &&
        WriteSelfTestFile(manifest_path, content) &&
    ...
    ok = ok && !ParseLaunchManifestContent(
        ...
        parsed_fields,
        diagnostic);
    std::string v1_manifest_schema_content = content;
    const std::string v2_manifest_schema =
        std::string("manifest_schema=") + kLaunchManifestSchema + '\n';
    const size_t v1_manifest_schema_offset =
        v1_manifest_schema_content.find(v2_manifest_schema);
    if (v1_manifest_schema_offset == std::string::npos) ok = false;
    else {
        v1_manifest_schema_content.replace(
            v1_manifest_schema_offset,
            v2_manifest_schema.size(),
            "manifest_schema=wirehair-rdpru-target-launch-manifest-v1\n");
    }
    parsed_fields.clear();
    ok = ok && !ParseLaunchManifestContent(
        v1_manifest_schema_content,
        target_cpu,
        output,
        executable_sha256,
        executable_build_id,
        parsed_fields,
        diagnostic);
    std::string v1_identity_schema_content = content;
    const std::string v2_identity_schema =
        std::string("target_identity_schema=") + kTargetIdentitySchema + '\n';
    const size_t v1_identity_schema_offset =
        v1_identity_schema_content.find(v2_identity_schema);
    if (v1_identity_schema_offset == std::string::npos) ok = false;
    else {
        v1_identity_schema_content.replace(
            v1_identity_schema_offset,
            v2_identity_schema.size(),
            "target_identity_schema="
            "wirehair-rdpru-target-identity-receipt-v1\n");
    }
    parsed_fields.clear();
    ok = ok && !ParseLaunchManifestContent(
        v1_identity_schema_content,
        target_cpu,
        output,
        executable_sha256,
        executable_build_id,
...
bool RunSelfTest()
{
    if (!EmbeddedIdentitiesValid() ||
        ...
        !IsLowerHexSha256(WIREHAIR_WH2_NATIVE_CODEC_SOURCE_SHA256))
    {
        std::cerr << "native RDPRU batch128 A/A target-v2 selftest failed: embedded hashes\n";
        return false;
    }
    struct Test
    {
    ...
    const Test tests[] = {
        { "target-identity-module-integration",
          TestTargetIdentityModuleIntegration },
        { "target-identity-checkpoint-sequencing",
          TestIdentityCheckpointSequencing },
    ...
    for (size_t i = 0u; i < sizeof(tests) / sizeof(tests[0]); ++i)
    {
        if (!tests[i].Run())
        {
            std::cerr << "native RDPRU batch128 A/A target-v2 selftest failed: "
                      << tests[i].Name << '\n';
            return false;
        }
    ...
    std::cout << "SELFTEST_SOURCE,sha256="
              << WIREHAIR_WH2_NATIVE_RDPRU_AA_V2_SOURCE_SHA256 << '\n'
              << "WIREHAIR1_NATIVE_RDPRU_BATCH128_AA_TARGET_V2_SELFTEST=PASS\n";
    return true;
}

void PrintUsage(std::ostream& output)
{
    output << "Usage: wirehair_wh2_native_rdpru_batch128_aa_calibration_v2 "
           << "--selftest\n       "
    ...
    std::ostream& diagnostic_output)
{
    ...
    {
        diagnostic_output << "native RDPRU target-v2 main exception: "
                          << exception.what() << '\n';
    }
    catch (...)
    {
        diagnostic_output << "native RDPRU target-v2 main non-standard exception\n";
    }
    terminal_output <<
        "WIREHAIR1_NATIVE_RDPRU_BATCH128_AA_TARGET_V2_CALIBRATION=INVALID\n";
    terminal_output.flush();
