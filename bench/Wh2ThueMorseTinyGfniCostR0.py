#!/usr/bin/env python3
"""One-shot four-arm .74 full-encoder screen; replay never executes a codec."""
import argparse
...
ROOT = A.ROOT
PROTOCOL = "wirehair.wh2.thue-tiny-gfni-cost-r0"
OUTPUT = Path("/var/tmp/wh2-thue-tiny-gfni-cost-r0")
TARGET = "wh2_thue_tiny_gfni_cost_r0"
RAW_CAP, ERR_CAP, TOTAL_CAP = 32 * 1024**2, 65536, 64 * 1024**2
WORKER_WALL, WORKER_CPU, CONTROLLER_WALL, OBSERVER_WALL = 30, 28, 40, 50
WORK_CAP = 8 * 10**9
BATCH = 128
...
NEW_SOURCES = tuple("bench/" + name for name in (
    "Wh2ThueMorseTinyGfniCostR0.py", "test_Wh2ThueMorseTinyGfniCostR0.py",
    "Wh2ThueMorseTinyGfniCostR0.cpp", "Wh2ThueMorseTinyGfniCostR0BridgeTest.cpp",
    "Wh2ThueMorseTinyGfniCostR0/CMakeLists.txt"))
...
def current_receipt(build, deadline):
    ...
    support = ("Wh2ThueMorseTinyGfniR0.cpp", "Wh2ThueMorseNativeCodec.cpp",
               ...
               "Wh2ThueMorseMatvecCostR0Bridge.cpp", "Wh2ThueMorseMatvecCostR0Bridge.cpp",
               "Wh2ThueMorseTinyGfniCostR0.cpp", "Wh2RdpruTargetIdentityV2.cpp",
