...
SPEC = importlib.util.spec_from_file_location('classification_tested',
    Path(__file__).with_name('Wh2ProfileClassificationCostR0.py'))
...
class Tests(unittest.TestCase):
    ...
    def test_small_rows_against_separate_oracles(self):
        ...
        for k in (5,8):
            oracle = C.R.sibling('classification_oracle_'+str(k),'Wh2K%dPublicRecoveryR0.py'%k)
    ...
    def test_generated_worker_isolation_and_limits(self):
        ...
        self.assertIn('#include "Wh2ProfileClassificationCommon.h"',worker)
    ...
    def test_unregistered_import_closure(self):
        ...
        parent.__file__ = str(C.ROOT/'bench/Wh2ProfileClassificationCostBuildR0.py')
    ...
    def test_mutable_exceptions_cannot_include_production(self):
        self.assertEqual(set(B.MUTABLE_HARNESS),{
            'bench/Wh2ProfileClassificationCostR0.py','bench/Wh2ProfileClassificationCostBuildR0.py',
            'bench/test_Wh2ProfileClassificationCostR0.py','bench/Wh2ProfileClassificationCostR0.md'})
