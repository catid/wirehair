#!/usr/bin/env python3
"""One frozen full-lifecycle comparison of the qualified single-predicate overlay."""
import argparse
...
B = sibling('_classification_cost_build','Wh2ProfileClassificationCostBuildR0.py')
D = sibling('_classification_cost_deferred','Wh2CurrentPreservedDeferredCostR0.py')
R, A, ROOT = D.R, B.A, B.ROOT
PROTOCOL = 'wirehair.wh2.profile-classification-cost-r0'
OUTPUT = Path('/var/tmp/wh2-profile-classification-cost-r0')
# Filled from the sole byte-verified preparation, before any worker qualification.
CANDIDATE_SHA = '01fe2c9d9c5b112a757b6e540d1da9344436dab17fc3c76729b37135781e8be0'
PREPARATION_SHA = 'b78399a9bcd677ff413c2dcfc26aa42632483ab710d6160019b64b428f038be6'
CASES = R.CASES + tuple((4,k,b,p) for k in (3,5,8) for b in (2,64,1280) for p in (1,2))
SOURCES = D.NEW + ('bench/Wh2ProfileClassificationCostR0.py',
    'bench/Wh2ProfileClassificationCostBuildR0.py','bench/test_Wh2ProfileClassificationCostR0.py',
    'bench/Wh2ProfileClassificationCostR0.md','bench/Wh2K8PublicCostBuildR0.py',
    'bench/Wh2ProfileClassification/CMakeLists.txt','bench/Wh2ProfileClassification/ValidationTest.cpp',
    'bench/Wh2ProfileClassification/CheckParity.cmake','bench/Wh2ProfileClassification/README.md',
    'test/V2SmallCodecTest.cpp','codec/V2ProfileTest.cpp','test/V2CertifiedCompatibility.cpp',
    str(B.COMMON),str(B.WORKER))
