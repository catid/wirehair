...
struct PrecodeSolveStats
{
    ...
    */
    ...
    // seam.  After the configured invalid-root proof pops, the heap must be
    // guaranteed to contain CutoffKeys entries beyond the maximum possible
    // rebuild output before compaction may trigger once.
