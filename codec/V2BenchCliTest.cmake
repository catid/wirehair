...
if(NOT result MATCHES "^-?[0-9]+$" OR NOT result EQUAL 0 OR
    ...
    NOT out MATCHES
        "mixed_null_row,v=2,row=0.*sf_hash=cb3ab68d3ac8b9c4.*ex_hash=be52b9be6f9d47a6.*pair_hash=78e77a1db4dacc7b" OR
    NOT out MATCHES
        "mixed_null_row,v=2,row=1.*sf_hash=596023278d8fd107.*ex_hash=9dd32dc060d03dc5.*pair_hash=86fb1d0bc060b438" OR
    out MATCHES "mixed_null_row,v=2,row=2")
    message(FATAL_ERROR
...
if(NOT result MATCHES "^-?[0-9]+$" OR NOT result EQUAL 0 OR
    NOT out MATCHES
        "mixed_null_witnesses=1 mixed_independent_gf256_breaker_residues=1 mixed_independent_gf256_breaker_rows=1 mixed_gf256_breaker_residue_seed_xor=0xb7e15162" OR
    NOT out MATCHES "945,1280,periodic,2,0,1,1,0,0," OR
    NOT out MATCHES
        "mixed_null_witness,v=2,N=945,bb=1280,trial=-1,status=none,reason=no_need_more.*hash_seed=0xf090c9ff.*breaker_rows=1,breaker_hash_seed0=0x4771989e,independent_gf256_breaker=1,L=1019" OR
    out MATCHES "mixed_null_row")
    message(FATAL_ERROR
...
expect_failure("must be in \\[0,3\\]" precodefail
    --N 64 --bb-list 8 --overhead 0 --trials 1 --threads 1 --loss 0.1
    --completion mixed --mixed-gf256-rows 11 --mixed-gf16-rows 4
    --mixed-period 32 --mixed-geometry shared-x
    --mixed-residue-schedule hashed --mixed-independent-extension-residues
    --mixed-independent-gf256-breaker-rows 4)
expect_failure("conflicts with --mixed-independent-gf256-breaker-rows"
    precodefail
    --N 64 --bb-list 8 --overhead 0 --trials 1 --threads 1 --loss 0.1
    --completion mixed --mixed-gf256-rows 11 --mixed-gf16-rows 4
    --mixed-period 32 --mixed-geometry shared-x
    --mixed-residue-schedule hashed --mixed-independent-extension-residues
    --mixed-independent-gf256-breaker-residues
    --mixed-independent-gf256-breaker-rows 2)
expect_failure("expects auto, off, or on" precodefail
    --N 64 --bb-list 8 --overhead 0 --trials 1 --threads 1 --loss 0.1
    --completion mixed --mixed-fused-schedule-buckets maybe)
expect_failure("requires --mixed-independent-extension-residues" precodefail
    --N 64 --bb-list 8 --overhead 0 --trials 1 --threads 1 --loss 0.1
    --completion mixed --mixed-fused-schedule-buckets on)
expect_success("breaker_rows=3" precodefail
    --N 945 --bb-list 64 --overhead 0 --trials 1 --threads 1
    --loss 0.35 --seed 0xa11ce520f84d877e --schedule burst
    --completion mixed --mix-count 2 --binary-dense-rows 13
    --mixed-gf256-rows 11 --mixed-gf16-rows 4 --mixed-period 32
    --mixed-geometry shared-x --mixed-residue-schedule hashed
    ...
    --mixed-independent-extension-residues
    --mixed-extension-residue-seed-xor 78
    --mixed-fused-schedule-buckets on
    --mixed-independent-gf256-breaker-rows 3)
