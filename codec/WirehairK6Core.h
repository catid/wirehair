#ifndef WIREHAIR_K6_CORE_H
#define WIREHAIR_K6_CORE_H

#include <cstddef>
#include <cstdint>
#include <memory>

// Private K6 equation core. The installed C boundary owns its fixed lookup.
// Call wirehair_init()/gf256_init() once before using this shared GF runtime.
namespace wirehair_k6_core {
...
// contents are fixed by the C boundary, not reconstructed by this core.
struct Lookup {
