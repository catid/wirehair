...
// and correctness harness (including screened K2/K4). Existing K6 does not include this file.
...
template<unsigned K> struct Geometry {
    static_assert(K == 2 || K == 3 || K == 4 || K == 5 || K == 6 || K == 8, "Only the screened K2/K3/K4/K5/K6/K8 dimensions are supported");
    enum : std::size_t {
...
template<unsigned K> class Encoder {
    static_assert(K == 2 || K == 3 || K == 4 || K == 5 || K == 6 || K == 8, "Only K2/K3/K4/K5/K6/K8 handles are supported");
